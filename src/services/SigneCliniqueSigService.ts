...
export class SigneCliniqueSigService {
  ...
  public deleteSigneCliniques(numDoss, dateFeuille, nature, codeType) {
    ...
    db.openDatabase({
      ...
      db.executeSql("delete from SigneCliniqueSig where numDoss like '" + numDoss + "' and dateFeuille like '" + dateFeuille + "' and nature like '" + nature + "' and codetypeof like '" + codeType + "'", [])
        .then(() => {
