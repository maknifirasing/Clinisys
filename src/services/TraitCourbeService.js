...
var TraitementService = (function () {
    ...
    TraitementService.prototype.verifTraitCourbe = function (traitCourbes, numDoss, codeClinique) {
        var _this = this;
    ...
    TraitementService.prototype.getTraitCourbes = function (traitCourbes, numDoss, codeClinique) {
        var _this = this;
        var db = new SQLite();
        db.openDatabase({
            name: 'clinisys.db',
    ...
    TraitementService.prototype._insertTraitCourbes = function (traitCourbes) {
        var db = new SQLite();
        db.openDatabase({
            name: 'clinisys.db',
            location: 'default' // the location field is required
    ...
    TraitementService.prototype.deleteTraitCourbes = function (numDoss, codeClinique) {
        var db = new SQLite();
        db.openDatabase({
            name: 'clinisys.db',
            location: 'default' // the location field is required
