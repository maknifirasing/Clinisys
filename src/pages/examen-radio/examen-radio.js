    ...
    ExamenRadioPage.prototype.getdocumentById = function (observ) {
        ...
        this.platform.ready().then(function () {
            ...
            if (_this.connection === false) {
                _this.navCtrl.push(DocViewPage, { observ: observ, codeClinique: _this.codeClinique });
            }
            else {
                var d = new Document();
                d.seturl(_this.storageDirectory + observ + ".html");
                d.setobserv(observ + ".html");
                ...
                _this.url = "http://192.168.0.5:8084/dmi-web/DemandeRadio?type=consult&function=getdocumentById&idDoc=" + observ + ".html";
                _this.open(_this.url);
                _this.retrieveImage(_this.url, d);
            }
        });
        //  this.navCtrl.push(DocViewPage, { doc: d });
    };
