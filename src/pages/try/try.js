...
var TryPage = (function () {
    function TryPage(navCtrl, navParams, Url, platform, themeableBrowser, alertCtrl, transfer, file, sqlite) {
    ...
    TryPage.prototype.getdocumentById = function (observ) {
        var _this = this;
        observ += ".html";
    ...
    TryPage.prototype.open = function (url) {
    ...
    TryPage.prototype.downloadImage = function (url, doc) {
        var _this = this;
        this.platform.ready().then(function () {
    ...
    TryPage.prototype.retrieveImage = function (url, doc) {
        var _this = this;
    ...
    TryPage.prototype.retrieveImageOff = function (doc) {
        var _this = this;
        var file = doc.getobserv();
        this.file.checkFile(this.storageDirectory, file)
            .then(function () {
    ...
    TryPage.prototype.GetExamenRadioByNumDossResponseOff = function (numDoss, codeClinique) {
    ...
    TryPage.prototype.goToInfPage = function (patient) {
